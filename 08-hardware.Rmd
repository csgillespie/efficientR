...
since $2^7 = 128$, but $8$ bits were typically used for performance [reasons](http://stackoverflow.com/q/14690159/203420). Table 8.1 gives the binary representation of the first few characters.
...
```{r 8-1, fig.cap="Two 8GB RAM cards. Credit: Wikimedia.org" , echo=FALSE}
knitr::include_graphics("figures/f8_1_ram.jpg")
```
