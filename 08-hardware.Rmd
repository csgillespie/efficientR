...
## Top 5 tips for efficient hardware
  ...
  - Use the package **benchmarkme** to assess your CPUs number crunching ability; 
...
```{r 8-1, fig.cap="Three DIMM slots on a computer motherboard used for increasing the amount of available RAM. Credit: Wikimedia.org", echo=FALSE}
