...
professor) at Newcastle University, UK. He has been running [R
courses](http://www.ncl.ac.uk/maths/rcourse/) for over five years at a variety of
levels, ranging from beginners to advanced programming. His research interests are
high performance statistical computing and Bayesian statistics.

Robin Lovelace is a Research Fellow in the Leeds Institute for Data Analytics, which
...
Introduction to visualising spatial data in R and is about to publish Spatial
microsimulation with R (CRC Press, forthcoming). Robin has used R on mission-critical
