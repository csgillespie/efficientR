...
abline(v=as.Date("2016-04-03"), col="grey90", lty=2)

text(as.Date("2013-04-03"), 11800, "R 3.0", pos=4, col="grey50")
text(as.Date("2014-04-03"), 11800, "R 3.1", pos=4, col="grey50")
text(as.Date("2015-04-03"), 11800, "R 3.2", pos=4, col="grey50")
text(as.Date("2016-04-03"), 11800, "R 3.3", pos=4, col="grey50")
