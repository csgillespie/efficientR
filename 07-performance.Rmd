...
A variety of code tweaks for achieving such
speed boost are covered in this chapter, which is organised as follows. It begins with general hints and tips about optimising base R.
Code profiling, which can identify bottlenecks in the code, is covered in the next section. The final section  
