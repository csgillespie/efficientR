...
Sorting a vector is a relatively expensive computational operation (compared to
calculating the mean, say). If you only sort a vector once at the top of a script, then
don't worry too much about this. However if you sorting inside a loop, or in a shiny
application, then it can be worthwhile thinking about how to optimise this operation.
