...
convert a factor into its numerical equivalent. For example, our data 
has been converted to factor by `read.csv` since it contained a string. Using
...
to convert a factor to a number is slightly more efficient than `as.numeric(as.character(f))`, 
