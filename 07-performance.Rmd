...
passed to C or Fortran code. You might be tempted to use integers with the 
purpose of speeding up your R code. For example, if we look at the
...
However, integers are more space efficient. 
