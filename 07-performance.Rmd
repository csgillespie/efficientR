...
computer scientist who developed a number of the key alogorithms that we use today.
...
Section \@ref(performance-parallel) discusses how paralell code can overcome efficiency bottlenecks for some problems.
The final section explains how `Rcpp` can be used to efficiently incorparting C++ code into an R analysis.
...
To test whether a vector (or other obeject) contains missing
