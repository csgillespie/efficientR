...
- Use the `tbl` class, the defined by the **tibble** package and the default object type of **dplyr**, to make data frames efficient to print and easier to work with.
...
```{r verbs, echo=FALSE}
verbs = frame_data(
  ~dplyr, ~functions, ~Description, ~Base,
  "A", "B", "C", "D"
)
  
verbs =                         read_csv("data/dplyr-verbs.csv")
# verbs = read_csv("data/reshape-pew.csv")
