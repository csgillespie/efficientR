...
```{r wco2, echo=FALSE, fig.cap="The geographical distribution of carbon dioxide emissions in 2012.", out.width="\\textwidth"}
...
```{r dtplot, fig.cap="Benchmark illustrating the performance gains to be expected for different dataset sizes.", echo=FALSE, fig.width=6, fig.height=4, out.width="0.7\\textwidth", fig.align="center"}
