...
2. Take a look at each of these datasets: what is 'untidy' about each?
...
<!-- __XXX__ The bit below is a bit odd. The data frame is a tibble. The class is printed in a column. I 
also think that your vapply command is **much** nicer, with `str` being more appropriate for the footnote.-->
