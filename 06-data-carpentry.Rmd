...
library("tidyr")
library("readr")
raw = read_csv("extdata/pew.csv") # read in the 'wide' dataset
dim(raw)
...
Tables \@ref(tab:tpew) and \@ref(tab:tpewt) show a subset of the `raw` and `rawt` datasets, respectively.
...
knitr::kable(rawt_mini, caption = "Long form of the Pew dataset represented above showing the minimum values for annual incomes (includes part time work).")
```
