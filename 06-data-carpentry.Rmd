...
also think that your vapply command is nicer, with `str` being more appropriate for the footnote.-->
...
<!-- __XXX__ Seems odd that for a chapter on dplyr, the dplyr solution is last -->
