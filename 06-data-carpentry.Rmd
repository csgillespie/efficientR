...
'Tibbles' can provide an small efficiency boost when creating data frames. Instead of writing a test data frame row-by-row, `frame_data()` enables the data to be written as it will be seen, as illustrated below in comparison with `data.frame()`.
