...
caption = "First 3 rows of the aggregated 'pew' dataset from Wickham (2014a) in an 'untidy' form."
knitr::kable(pew[1:3, 1:4], caption = caption)
```

```{r tpewt, echo=FALSE}
library("tidyr")
pewt = pivot_longer(pew, -religion)
pewt_mini = pivot_longer(pew[1:3, 1:4], -religion)
caption = "Long form of the Pew dataset represented above showing the minimum values for annual incomes (includes part time work)." #nolint
knitr::kable(pewt_mini, caption = caption)
```
...
```{r speed, echo=FALSE}
knitr::kable(top_table, digits = 0, caption = "The top 3 countries in terms of average CO2 emissions from transport since 1971, and growth in transport emissions over that period (MTCO2e/yr).") #nolint
```
