...
This book is for anyone who who wants to make their R code faster to type, faster to run and more reproducible and scalable. We assume you are either accustomed to R or proficient at programming in other languages. If you already program but want to learn how to use R, this book should be useful: it will help you navigate the quirks of the R language to make it work efficiently (it is easy to write slow R code if you write R code as it it were a general purpose language: it is not). If you write R code but don't consider yourself a programmer, it should make your R work more efficient. If you are an R beginner, you should probably read this book in parallel with other R resources such as the numerous, vignettes, tutorials and online articles that the R community has produced. At a bare minimum you should have R installed on your computer (see section \@ref(r-version) for information on how best to install R on new computers).
