...
This book has an associated R package that contains data sets and vignettes. The
...
The onlineversion will continue to evolve in between reprints of the physical book. 
The book was written using markdown and translated into the book form using the **bookdown** package.
The source of the book is available at https://github.com/csgillespie/efficientR. 
