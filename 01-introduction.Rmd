...
The results show summaries reporting how long each of the queries took in the units of time and with the number
of evaluations used in the benchmark (milliseconds and 100 in this case).
