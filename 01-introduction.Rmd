...
Throughout this book we use a consistent set of conventions to refer to code.
  ...
  * Occasionally we'll highlight the package an object is defined. In this case, we use 
  the package name follow by two colons, e.g. `microbenchmark::microbenchmark()`.
