...
```{r touch, echo=FALSE, fig.cap="The starting position for touch typing, with the fingers over the 'home keys'. Source: [Wikipedia](https://commons.wikimedia.org/wiki/File:QWERTY-home-keys-position.svg) under the Creative Commons license.", out.width="\\textwidth"}
...
microbenchmark(df[3, 2], df$name[3], df[3, 'v'])
```
...
```{r profvis-ice, echo=FALSE, fig.cap="Profiling results of loading and plotting NASA data on icesheet retreat.", out.width="\\textwidth"}
