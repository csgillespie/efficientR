...
Testing this hypothesis provides an ideal opportunity to introduce another commonly benchmarking function provided in base R: `system.time()`: 
...
For more information about profiling and benchmarking, please refer to the [Optimising code](http://adv-r.had.co.nz/Profiling.html) chapter in @Wickham2014, and Section \@ref(performance-profvis) in this book. We recommend 

#### Exercises

Consider the following benchmark to evaluate different methods to evaluate the cumulative sum of the whole numbers from 1 to 100:
