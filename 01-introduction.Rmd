...
When using `microbenchmark`, you need to pay careful attention to the units. In the above example, 
each function call takes approximately 20 _microseconds_; so one million function calls takes a second! 
