...
This chapter deals with coding standards and techniques. The only package required for this 
chapter is the **lubridate** package, which is used to illustrate good practice.
...
1. Refactor the following code chunk to make it more efficient:
