...
An illustrative example of a useful `.Rprofile` is shown in the example below, with comments explaining what each line does.
...
and online. The suggested `.Rprofile` settings at [statmethods.net](http://www.statmethods.net/interface/customizing.html)
...
These potentially annoying `+`s can be erradicated from you session by adding `options(continue = "  ")` to your `.Rprofile`.
```
