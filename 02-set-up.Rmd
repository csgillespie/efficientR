...
Resource monitoring is the process of checking the status of key OS variables, such as RAM usage.
For computationally intensive work, it is sensible to monitor system resources in this way.
Resource monitoring can help identify bottlenecks, such as when you are running low on RAM.
Alongside R profiling functions such as **profvis** (see Section \@ref(performance-profvis)), system monitoring provides a useful tool for understanding how R is performing in relation to the OS state.
