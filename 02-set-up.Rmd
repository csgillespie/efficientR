...
2. Start an activity monitor then type and execute the following code. How do the results on your system compare to those presented in Figure \@ref(fig:2-1)? Note: this will take around a minute or more depending on your computer.

    ```{r, eval=FALSE}
    # 1: Create large dataset
    X = matrix(rnorm(1e6), nrow = 1e5)
