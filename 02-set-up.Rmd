...
Typing the beginning of a function name, for example `rn` (short for `rnorm()`), and hitting `Tab` will result in the full function names associated with this text string being printed.
