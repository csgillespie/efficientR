...
```{r blas-bench, fig.width=6, fig.height=4,echo=FALSE, out.width="70%", fig.align="center", fig.cap="Performance gains obtained changing the underlying BLAS library (tests from `benchmark_std()`)."}
