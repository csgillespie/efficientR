...
and it is fast.
This chapter describes the software set-up decisions that will enable
a productive workflow, with an emphasis on the operating system and R set-up files
that are used each time R loads.
