...
Use the `rbenchmark` package to compare the vectorised construct `x = x + 1`, to the
...
res = rbenchmark::benchmark(m_plot_mpg(10), plot_mpg(10), 
...
# 3       mean(x)   0.032    1.000
# 2 cmp_mean_r(x)   0.260    8.125
# 1     mean_r(x)   1.848   57.750
```
