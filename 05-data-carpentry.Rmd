...
Imagine you have access to a database on food donations from a community support cafe.

```{r, eval=FALSE}
# Connect to a require package
library("RMySQL") # also loads required package DBI
