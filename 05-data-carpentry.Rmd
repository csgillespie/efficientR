...
Furthermore, **dplyr** is efficient to *learn* (see Chapter \@ref(efficient-learning). It has small number of intuitively named functions, or 'verbs', that can solve a wide range of data processing challenges. This encourages a consistent coding style. **dplyr**'s verbs are presented in Table \@ref(tab:verbs).
