...
#>    cs_for(x) 221475 243656 284514 297471 311995 451432   100
#>  cs_apply(x) 153830 176356 194731 197383 208547 353484   100
#>    cumsum(x)    554    717   1340    994   1180  17020   100
```
...
#> Unit: milliseconds
#>            expr   min    lq mean median    uq   max neval
#>     with_select  9.07  9.13  9.2   9.17  9.22  9.43     5
#>  without_select 13.79 13.87 14.4  14.02 14.57 15.98     5
```
...
#> Unit: milliseconds
#>         expr     min      lq   mean median      uq  max neval
#>  ex_mat[1, ] 0.00255 0.00368 0.0533 0.0062 0.00673 4.79   100
#>   ex_df[1, ] 0.81931 0.85768 0.9934 0.8721 0.90503 6.27   100
```
...
add_cpp
#> function (x, y) 
#> .Primitive(".Call")(<pointer: 0x2b86c0ae3220>, x, y)
```
