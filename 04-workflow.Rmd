...
Note that the data frame has 329 columns (and imagine it has 4 million+ rows instead of 9). That's a lot of variables. Do we need them all? It's worth taking a glimpse at this dataset to find out:
