...
Scale is a vital consideration because the importance of project management increases exponentially with the number of people involved.
Writing a 'one-off' R script requires no project management.
Working with dozens of developers to deliver a mission critical application for central government, on the other hand requires much effort dedicated to project management: regular meetings, division of labour and a scalable project management system to track progress, issues and
priorities will end up an increasing proportion of your time. Fortunately a multitude of dedicated project management systems can help with this task, including (in rough ascending order of scale and complexity):

- the interactive code sharing site [GitHub](https://github.com/) (more on this in Chapter \@ref(efficient-collaboration))
...
- the web-based and easy-to-use [Trello](https://trello.com/)
