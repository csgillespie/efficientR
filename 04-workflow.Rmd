...
dataset.
These steps illustrate how R can automate processes that are often performed manually, e.g. through the graphical user interface of a web browser. The result of the code below is data stored in the `data` directory ready to be read-in (note part of the dataset is also stored in the **efficient** package).
