...
Due to the conservative nature of base R development, which prioritises stability, much of the innovation and performance gains in the 'R ecosystem' has occurred in recent years in the packages.
...
library("data.table")
fname = system.file("extdata/voc_voyages.tsv", package = "efficient")
voyages_base = read.csv(fname, sep = "\t")
