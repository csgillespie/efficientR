...
R Markdown documents are plain text and have file extension `.Rmd`. The framework
...
This code, will result in the following output when the R Markdown document is compiled:
