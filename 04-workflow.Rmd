...
```{r phases, echo=FALSE, fig.width=6, fig.height=4,fig.cap="Schematic illustrations of key project phases and levels of activity over time, based on @PMBoK2000.", out.width="70%", fig.align="center"}
...
```{r timeline, echo=FALSE, fig.cap="A Gantt chart created using **DiagrammeR** illustrating the steps needed to complete this book at an early stage of its development.", out.width="80%", fig.align="center"}
