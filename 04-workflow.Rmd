...
```{r timeline, echo=FALSE, fig.cap="A Gantt chart created using **DiagrammeR** illustrating the steps needed to complete this book at an early stage of its development.", out.width="\\textwidth"}
...
```{r, echo=FALSE, out.width="0.25\\textwidth"}
