...
skills you will learn if you want to learn R *in depth*. We emphasise *depth* of
...
Sometimes a package will contain vignettes. To browse any vignettes associated with a
...
the [#rstats](https://twitter.com/search?q=%23rstats) twitter tag keeps you up-to-date
