...
1. Motivation to learn about a specific topic in R: what can it offer?
2. Exploration of R packages for helping in that domain area.
3. Discovery of specific function undertaking tasks in that topic area.
4. Looking into the source code to see precisely how it works.
