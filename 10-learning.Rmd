...
- Read about the latest developments in the R Journal and the 'blogosphere'.
- If stuck, ask for help! A clear question posted in an appropriate place, using reproducible code, should get an answer.
- Monitor the [R tag](stackoverflow.com/questions/tagged/r) at stackoverflow for new questions.
- Regularly browse R-bloggers to get an overview of the R ecosystem.
- Subscribe (but not necessarily post) to R email lists such as `R-devel` to find out how R is evolving.
