...
resources. Hence, the first few lines of a function perform argument checking.
...
powerlaws, I use messages to give the user an estimate of expected run time. Providing
a rough estimate of how long the function takes, allows the user to optimise their
