...
```
Figure \@{fig:3-2} highlights that voting patterns are clearly not uniform between $1$ and $10$. The
...
difference (figure \@ref(fig:3-3)).

```{r 3-3, echo=FALSE, fig.height=4, fig.width=6, fig.cap="Comparsion of mean functions.", eval=TRUE, fig.align="center", out.width="70%"}
