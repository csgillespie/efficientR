...
```{block, type="rmdtip"}
We recommending setting the compile level to the maximum value of 3.
```

The impact of compiling on install will vary from package to package: for packages
that already have lots of pre-compiled code speed gains will be small, as stated in the
