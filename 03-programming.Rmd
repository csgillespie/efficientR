...
1. Vectorise codes whenever possible.
1. Use factors when appropriate.
1. Clever use of S3 objects can make code easier to understand.
...
definition. If such a variable is found (and its binding is not locked) then its value
