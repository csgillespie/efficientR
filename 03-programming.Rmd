...
In this chapter we will introduce two new packages, **compiler** and **memoise**. The **compiler**
...
## Top 5 tips for efficient programming
  ...
  * Vectorise codes whenever possible.
...
R is a functional and object orientated language. There are many ways to explain this, but probably most concise and easy to remember is via a couple of 'slogans' [@chambers_object-oriented_2014]:

- "Everything that exists is an object.
- Everything that happens is a function call."

Furthermore, functions are themselves objects, any of which can be modified. This makes R extremely flexible [@Wickham2014].

In everyday use you don't need to worry much about objects. However, understanding something of their design and inner workings in some cases increase inefficiencies. There are 3 'class systems' in R: S3, S4 and Reference Classes. Readers interested in the details of each are directed towards the '[OO field guide](http://adv-r.had.co.nz/OO-essentials.html)' in @Wickham2014. From an efficiency perspective, S3 is most relevant for many applications. This is covered in the next section.
...
`axes` (see figure \@ref(fig:3-2).

```{r 3-2, fig.cap="S3 image method for data of class `dist`.", echo=FALSE, fig.asp=0.7, fig.width=5,fig.align="center"}
...
once. Students in my class uploaded R scipts. Using `source`, I was able to read
...
```{r 3-4, echo=FALSE, fig.height=4, fig.width=6, fig.cap="Comparsion of mean functions.", eval=TRUE, fig.align="center", out.width="70%"}
