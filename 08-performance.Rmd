...
In many scernios, code is running slowly due to a couple of key bottlenecks. By
...
```{r profvis1, echo=FALSE, fig.cap="Output from profvis", out.width="\\textwidth"}
...
```{r cranlog, echo=FALSE, fig.cap="Downloads per day from the RStudio CRAN mirror of packages that provide R interfaces to other languages.", warning=FALSE, fig.width=6, fig.height=4, out.width="70%", fig.align="center"}
...
```{r rcppcomp, fig.width=6, fig.height=4, echo=2, fig.cap="Comparison of mean functions.", echo=2, cache=TRUE, fig.pos='t', out.width="70%"}
