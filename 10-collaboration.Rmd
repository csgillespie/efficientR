...
```{r rstudio-git, fig.cap="The Git tab in RStudio", echo=FALSE, out.width="0.7\\textwidth"}
...
```{r rstudio-githist, fig.cap="The Git history navigation interface", echo=FALSE, out.width="\\textwidth"}
