...
cap = "Comparison of base, **readr** and **data.table** reading in the voyages data set."
knitr::kable(vcols, caption = cap)
```
...
# In some cases there will be no knock-on consequences of using faster functions provided
# by packages but you should be aware that it is a possibility.
