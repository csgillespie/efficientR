...
When we run the equilivent operation using **readr**, 
```{r, cache=TRUE}
...
There are limitations to plain text files. Even the trusty CSV format is "restricted to tabular data, lacks type-safety, and has limited precision for numeric values" [@JSSv071i02]. The [paper](https://www.jstatsoft.org/article/view/v071i02) provides an excellent overview of the issues associated with different file formats, and the various solutions that have been proposed.
